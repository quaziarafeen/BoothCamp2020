...
public class ConnectToSqlDB {
    ...
    public static Properties loadProperties() throws IOException {
        ...
        InputStream ism = new FileInputStream("C:\\Users\\Quazi\\IdeaProjects\\All project\\Team5_WebAutomationFramework_Weekdays_Selinium_December2019\\Generic\\src\\main\\java\\secret.properties");
        prop.load(ism);
        ism.close();
        return prop;
    }
